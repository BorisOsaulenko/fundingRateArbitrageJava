...
public abstract class ArbitrageStrategyTest {
	...
	private static ArbitrageSnapshot snapshot(
		...
		ExchangeSnapshot longExchange = new ExchangeSnapshot(longBook, fees, longFunding, longMark, 1);
		ExchangeSnapshot shortExchange = new ExchangeSnapshot(shortBook, fees, shortFunding, shortMark, 1);
