...
public class OkxPublicWsTest extends PublicWsTest {
	...
	private static final OkxPublicHttpClient publicHttpClient = new OkxPublicHttpClient(context);
	private static final OkxPublicWsClient client = new OkxPublicWsClient(context, messageHandler, publicHttpClient);
