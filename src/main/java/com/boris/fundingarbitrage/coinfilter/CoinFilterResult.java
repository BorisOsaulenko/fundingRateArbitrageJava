...
public record CoinFilterResult(
				...
				@NonNull ExchangeCoinMap<BigDecimal> lotSizesMap,
				@NonNull ExchangeCoinMap<Integer> fundingIntervalsMap,
				@NonNull ExchangeCoinMap<BookTicker> bookTickersMap,
				@NonNull ExchangeCoinMap<FundingRate> fundingRatesMap
) {
}
